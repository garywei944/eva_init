...
basic() {
  ...
  # System Essentials
  sudo apt -y install git zsh screen net-tools openssh-server wget curl zip rar unrar dos2unix htop bashtop traceroute shadowsocks-libev lazygit rsync jq shc nfw fonts-firacode gpg ttf-ancient-fonts fonts-powerline numlockx tmux pulseaudio
